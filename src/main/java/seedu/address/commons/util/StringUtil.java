...
public class StringUtil {
     ...
     *       containsSubstringIgnoreCase("ABc def", "bc d") == true
     *       containsSubstringIgnoreCase("ABc def", "AB") == true //partial match
     *       containsSubstringIgnoreCase("lidavid@example.com", "lidavid") == true //partial match
     *       </pre>
