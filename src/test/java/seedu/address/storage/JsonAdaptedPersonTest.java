...
public class JsonAdaptedPersonTest {
    ...
    private static final String VALID_INCOME_BRACKET = BENSON.getIncomeBracket() != null
            ? BENSON.getIncomeBracket().toString() : null;
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                 VALID_ADDRESS, VALID_AGE, VALID_PRIORITY, VALID_INCOME_BRACKET, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, INVALID_ADDRESS,
                 VALID_AGE, VALID_PRIORITY, VALID_INCOME_BRACKET, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                    null, VALID_AGE, VALID_PRIORITY, VALID_INCOME_BRACKET, VALID_TAGS);
    ...
    public void toModelType_invalidAge_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                ...
                VALID_ADDRESS, INVALID_AGE, VALID_PRIORITY, VALID_INCOME_BRACKET, VALID_TAGS);
    ...
    public void toModelType_invalidIncomeBracket_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_AGE, VALID_PRIORITY, INVALID_INCOME_BRACKET, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_AGE, VALID_PRIORITY, VALID_INCOME_BRACKET, invalidTags);
