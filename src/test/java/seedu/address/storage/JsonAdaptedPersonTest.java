...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_PRIORITY, VALID_LAST_CONTACTED_DATE, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_PRIORITY, VALID_LAST_CONTACTED_DATE, VALID_TAGS);
        assertThrows(IllegalValueException.class, () -> person.toModelType());
    }
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                null, VALID_PRIORITY, VALID_LAST_CONTACTED_DATE, VALID_TAGS);
        assertThrows(IllegalValueException.class, () -> person.toModelType());
    }
    ...
    public void toModelType_invalidLastContactedDate_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_PRIORITY, INVALID_LAST_CONTACTED_DATE, VALID_TAGS);
        assertThrows(IllegalValueException.class, () -> person.toModelType());
    }

    @Test
    public void toModelType_nullLastContactedDate_throwsIllegalValueException() {
        // Null lastContactedDate is allowed for backward compatibility and defaults to empty string
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_PRIORITY, null, VALID_TAGS);
        try {
            person.toModelType();
        } catch (IllegalValueException e) {
            throw new AssertionError("Should not throw exception for null lastContactedDate");
        }
    }
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_PRIORITY, VALID_LAST_CONTACTED_DATE, invalidTags);
        assertThrows(IllegalValueException.class, () -> person.toModelType());
    }
}
