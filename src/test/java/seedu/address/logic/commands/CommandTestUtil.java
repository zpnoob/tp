...
public class CommandTestUtil {
    ...
    public static final String VALID_INCOME_BRACKET_AMY = "HIGH";
    ...
    public static final String INCOME_BRACKET_DESC_AMY = " " + PREFIX_INCOME_BRACKET + VALID_INCOME_BRACKET_AMY;
