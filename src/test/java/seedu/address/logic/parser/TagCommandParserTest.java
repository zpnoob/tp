...
public class TagCommandParserTest {
    ...
    public void parse_missingParts_failure() {
        assertParseFailure(parser, " t/friend", MESSAGE_INVALID_FORMAT); // no index
        assertParseFailure(parser, "1", MESSAGE_INVALID_FORMAT);         // no tag
        assertParseFailure(parser, "", MESSAGE_INVALID_FORMAT);          // empty input
    }

    @Test
    public void parse_invalidPreamble_failure() {
        assertParseFailure(parser, "-1 t/friend", MESSAGE_INVALID_FORMAT);  // negative index
        assertParseFailure(parser, "0 t/friend", MESSAGE_INVALID_FORMAT);   // zero index
        assertParseFailure(parser, "abc t/friend", MESSAGE_INVALID_FORMAT); // non-numeric
    }
    ...
    public void parse_validSingleTag_success() {
        ...
        String userInput = targetIndex.getOneBased() + TAG_DESC_FRIEND; // "1 t/friend"
