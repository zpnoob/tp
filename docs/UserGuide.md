...
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [pr/PRIORITY] [o/OCCUPATION] [t/TAG]…​`

- `PRIORITY` must be one of: `NONE`, `LOW`, `MEDIUM`, `HIGH` (case-insensitive)
- `OCCUPATION` can be any non-blank value. If omitted, occupation defaults to empty.
...
- `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 o/Engineer`
- `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 t/criminal pr/HIGH o/Former Guard`
- `add n/Jane Smith p/87654321 e/jane@example.com a/456 Main St pr/MEDIUM t/colleague o/Accountant`
...
Format: `edit INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [pr/PRIORITY] [o/OCCUPATION] [t/TAG]…​`
...
- `edit 2 n/Betsy Crower o/Teacher t/ pr/HIGH` Edits the name of the 2nd person to be `Betsy Crower`, sets occupation to `Teacher`, clears all existing tags and changes the priority to HIGH.
...
| ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Add**      | `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [pr/PRIORITY] [o/OCCUPATION] [t/TAG]…​` <br> e.g., `add n/James Ho p/22224444 e/jamesho@example.com a/123, Clementi Rd pr/HIGH o/Agent t/friend t/colleague` |
| **Clear**    | `clear`                                                                                                                                                                                                   |
