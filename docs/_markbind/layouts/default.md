...
<header sticky>
  <navbar type="dark">
    <a slot="brand" href="{{baseUrl}}/index.html" title="Home" class="navbar-brand">InsuraBook 📚</a>
...
* [User Guide]({{ baseUrl }}/UserGuide.html) :expanded:
  ...
  * [Parameters]({{ baseUrl }}/UserGuide.html#parameters)
...
* [Developer Guide]({{ baseUrl }}/DeveloperGuide.html) :expanded:
  ...
  * [Appendix: Future Enhancements]({{ baseUrl }}/DeveloperGuide.html#appendix-future-enhancements)
